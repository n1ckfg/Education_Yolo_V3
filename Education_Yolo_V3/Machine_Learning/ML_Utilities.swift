...
let labels = [ "aut fifth page", "aut first page", "aut fourth page", "aut last page", "aut second page", "aut third page",
               "aut", "book cover", "book first page", "book food page", "book santa page", "bread", "chocolate", "croagunk",
               "liverpool fc", "marill", "match attax", "milkshake", "pokemon online", "pokemon", "ships", "tangela"]
